...
class IOSchedCollectionViewHeaderCell: UICollectionReusableView {
  ...
  override init(frame: CGRect) {
    ...
    timeLabel.textColor = UIColor(hex: "#4768fd")
    timeLabel.textAlignment = .center
    timeLabel.translatesAutoresizingMaskIntoConstraints = false
    timeLabel.lineBreakMode = .byClipping

    ampmLabel.textColor = UIColor(hex: "#4768fd")
  ...
  private func setDate() {
    ...
    let dateFormatter = IOSchedCollectionViewHeaderCell.dateFormatter
  ...
  override var accessibilityLabel: String? {
    get {
      ...
      return IOSchedCollectionViewHeaderCell.dateFormatter.string(from: date)
    } set {}
  }
...
extension IOSchedCollectionViewHeaderCell {
